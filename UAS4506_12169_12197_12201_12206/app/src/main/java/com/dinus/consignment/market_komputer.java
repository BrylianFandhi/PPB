...
public class market_komputer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_market_komputer);
        ...
        data = new ArrayList<>();
        for (int i = 0; i < m_komputer.Headline.length; i++){
            data.add(new itemModel(m_komputer.Headline[i],
                    m_komputer.Subitem[i],
                    m_komputer.Jenis[0],
                    m_komputer.iconList[i],
                    m_komputer.Dekripsi[i]));
        }
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(market_komputer.this, main_market.class);
                startActivity(i);
            }
        });
    }
