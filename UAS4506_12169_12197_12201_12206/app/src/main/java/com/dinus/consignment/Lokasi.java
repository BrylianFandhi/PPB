...
import com.dinus.consignment.databinding.ActivityLokasiBinding;
...
private ActivityLokasiBinding binding;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney = new LatLng(-6.802969, 110.983101);
        mMap.addMarker(new MarkerOptions().position(sydney).title("My Shop Location"));
        float zoom=17.7f;
